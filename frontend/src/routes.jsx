...
export const router = createBrowserRouter([
  ...
  { path: '/extraction', Component: ExtractionScreen },
  { path: '/preview',    Component: PreviewDashboard },
  { path: '/deploy',     Component: DeploymentScreen },
 
  // ── Auth routes ────────────────────────────────────────────────────────────
  { path: '/login',  element: <AuthPage mode="login"  /> },   // ← NEW
  { path: '/signup', element: <AuthPage mode="signup" /> },   // ← NEW
]);
