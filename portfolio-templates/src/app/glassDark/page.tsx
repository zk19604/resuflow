    ...
    >
      <GlassCard className="overflow-hidden p-0">
        ...
        >
          {isHovered && (
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="absolute inset-0 bg-[#C850C0]/20 flex items-center justify-center"
            >
        ...
        <div className="p-6">
          ...
          <p className="text-white/55 text-[13px] leading-relaxed mb-4 line-clamp-2">
            {project.description}
          </p>
          <div className="flex items-center justify-between">
            <div className="flex gap-2 flex-wrap">
              {project.tags.slice(0, 3).map((tag: string) => (
                <span
                  key={tag}
                  className="px-2 py-1 rounded-full bg-white/5 text-white/60 text-[10px]"
                >
                  {tag}
                </span>
              ))}
            ...
            <span
              className="text-[12px] font-medium gradient-text cursor-pointer"
            >
              View Case Study →
            </span>
          </div>
  ...
  return (
    ...
    >
      ...
      >
        <button
          onClick={onClose}
          className="absolute top-6 right-6 text-white text-2xl hover:text-[#C850C0] transition-colors"
        >
          <X />
        </button>

        <div
          className="w-full h-[300px] rounded-2xl mb-6"
        ...
        <p className="text-white/60 text-[15px] leading-[1.8] mb-6">
          This project involved comprehensive research, user testing, and iterative design
          processes to create an intuitive and engaging user experience.
        </p>
        ...
        <div className="mb-6">
          ...
          <div className="flex gap-2 flex-wrap">
            {project.tags.map((tag: string) => (
              <span
                key={tag}
                className="px-4 py-2 rounded-full bg-white/5 border border-white/10 text-white/70 text-[12px]"
              >
                {tag}
              </span>
            ))}
        ...
        <div className="flex gap-4">
          <button
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.boxShadow = '0 0 28px rgba(200, 80, 192, 0.5)';
            }}
            onMouseLeave={(e) => {
          ...
          <button
            onClick={onClose}
            className="px-6 py-3 rounded-xl border border-white/20 text-white font-semibold text-[14px] hover:border-[#C850C0]/50 transition-all"
          >
            Close
          </button>
        </div>
...
export default function App() {
  ...
  const projects = [
    {
      ...
      category: 'UI/UX',
      description: 'Modern banking dashboard with real-time analytics and transaction management.',
    ...
    },
    {
      ...
      category: 'Branding',
      description: 'Complete brand identity for sustainable skincare startup including logo and packaging.',
    ...
    },
    {
      ...
      tags: ['Webflow', 'Framer', 'UX Research'],
    },
    {
      id: 4,
      name: 'Fitness Tracking App',
      category: 'UI/UX',
      description: 'Mobile app for workout tracking with social features and personalized plans.',
  ...
  // Copy email
  const copyEmail = () => {
    navigator.clipboard.writeText('fatima.mazhar@email.com');
    setEmailCopied(true);
    ...
    <div className="relative bg-[#0D0B1E] text-white overflow-x-hidden">
      ...
      >
        <div className="max-w-[1400px] mx-auto px-8 h-full flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div
              className="w-8 h-8 rounded-lg flex items-center justify-center text-white font-bold text-[16px]"
              style={{ background: 'linear-gradient(135deg, #C850C0, #4158D0)' }}
            >
              F
            </div>
            <span className="text-white font-semibold text-[15px]">Fatima Mazhar</span>
          </div>
          ...
          <div className="flex items-center gap-8">
            {['Home', 'About', 'Skills', 'Work', 'Contact'].map((item) => (
              <button
                ...
                className={`font-medium text-[13px] transition-all ${
          ...
          <button
            ...
            style={{ background: 'linear-gradient(135deg, #C850C0, #4158D0)' }}
            onMouseEnter={(e) => {
              e.currentTarget.style.boxShadow = '0 0 20px rgba(200, 80, 192, 0.4)';
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.boxShadow = 'none';
            }}
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center px-8 pt-16">
        ...
        <div className="max-w-[1400px] w-full flex items-center justify-between">
          ...
          <div className="max-w-[800px]">
            ...
            >
              UI/UX Designer & Brand Strategist based in Lahore, Pakistan. I turn complex
            ...
            >
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.borderColor = 'rgba(200, 80, 192, 0.5)';
                }}
                onMouseLeave={(e) => {
          ...
          >
            ...
            >
              <GlassCard className="w-[280px] h-[340px] p-8 flex flex-col items-center" hover={false}>
                ...
                <h3 className="text-white font-bold text-[18px] mb-1">Fatima Mazhar</h3>
                <p className="text-white/55 text-[13px] mb-6">UI/UX Designer</p>
                <div className="w-full grid grid-cols-3 gap-4 text-center">
                  <div>
                    <div className="text-white font-extrabold text-[28px] gradient-text">24+</div>
                    <div className="text-white/40 text-[11px]">Projects</div>
                  </div>
                  <div>
                    <div className="text-white font-extrabold text-[28px] gradient-text">18+</div>
                    <div className="text-white/40 text-[11px]">Clients</div>
                  </div>
                  <div>
                    <div className="text-white font-extrabold text-[28px] gradient-text">3+</div>
                    <div className="text-white/40 text-[11px]">Years</div>
                  </div>
                </div>
              </GlassCard>
            </motion.div>
      ...
      <section id="about" className="relative py-32 px-8 bg-[#0D0B1E]">
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
            <div className="text-[10px] uppercase tracking-[0.15em] gradient-text font-medium mb-3">
              About Me
            </div>
            <h2 className="text-[40px] font-bold">
              Passionate about <span className="gradient-text">crafting beauty</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <GlassCard className="p-8 flex flex-col items-center">
              ...
              <h3 className="text-white font-bold text-[22px] mb-1">Fatima Mazhar</h3>
              <p className="text-white/55 text-[14px] mb-6">UI/UX Designer & Strategist</p>

              <div className="flex gap-3 mb-6">
                {[Github, Linkedin, Twitter].map((Icon, i) => (
                  <button
                    key={i}
                    className="w-10 h-10 rounded-full flex items-center justify-center text-white/70 hover:text-white transition-all glass-card"
                    onMouseEnter={(e) => {
              ...
              <div className="flex gap-2 mb-6 p-1 rounded-full" style={{ background: 'rgba(255, 255, 255, 0.05)' }}>
                {[
                  ...
                  <button
                    ...
                    className={`flex-1 px-6 py-2.5 rounded-full font-medium text-[13px] transition-all ${
                      activeTab === tab.id
                        ? 'text-white'
                ...
                {activeTab === 'story' && (
                  <div className="space-y-4">
                    <p className="text-white/60 text-[15px] leading-[1.9]">
                      My journey into design started with a curiosity about how things work and
                      a passion for making them better. Over the past 3 years, I've had the
                      privilege of working with startups and established brands, helping them
                      create meaningful digital experiences.
                    </p>
                    <p className="text-white/60 text-[15px] leading-[1.9]">
                      I believe great design isn't just about aesthetics—it's about solving real
                      problems for real people. Every project is an opportunity to learn, grow,
                    ...
                    {[
                      {
                        ...
                        desc: 'Understanding user needs and business goals through thorough research.',
                      },
                      {
                        num: '02',
                        title: 'Iterate & Test',
                        desc: 'Creating prototypes and gathering feedback to refine the solution.',
                      },
                      {
                        num: '03',
                        title: 'Deliver Excellence',
                        desc: 'Crafting polished, pixel-perfect designs ready for development.',
                      },
                    ].map((principle) => (
                      <div key={principle.num} className="flex gap-4">
                        <div className="text-[48px] font-extrabold gradient-text leading-none">
                          {principle.num}
                        </div>
                        <div className="flex-1">
                          ...
                          <p className="text-white/55 text-[14px]">{principle.desc}</p>
                        </div>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {[
                      ...
                      <motion.div
                        key={fact}
                        whileHover={{ y: -4 }}
                        className="glass-card px-5 py-3 text-white text-[13px] cursor-default"
                      >
                        {fact}
                      </motion.div>
                    ))}
      ...
      <section id="skills" className="relative py-32 px-8 bg-[#120F2D]">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-[40px] font-bold">
              My technical <span className="gradient-text">skill set</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
            ...
            <div>
              ...
              <SkillBar name="UI Design" percentage={88} />
              <SkillBar name="Brand Identity" percentage={85} />
              <SkillBar name="Prototyping" percentage={80} />
              <SkillBar name="Design Systems" percentage={75} />
              <SkillBar name="Motion Design" percentage={65} />
            </div>

            {/* Skill Tags */}
            <div>
              <div className="text-[10px] uppercase tracking-[0.15em] text-white/40 font-medium mb-4">
                Tools & Technologies
              </div>
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <motion.div
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.borderColor = 'rgba(200, 80, 192, 0.4)';
                    }}
                    onMouseLeave={(e) => {
            ...
            <div className="flex justify-center gap-2 p-1 rounded-full inline-flex" style={{ background: 'rgba(255, 255, 255, 0.05)' }}>
              {[
                ...
                <button
                  ...
                  className={`px-6 py-2 rounded-full font-medium text-[13px] transition-all ${
                    activeFilter === filter.id ? 'text-white' : 'text-white/40 hover:text-white/70'
                  }`}
                  style={
            ...
            <div>
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <button
                      onClick={copyEmail}
                      className="text-white font-medium text-[14px] hover:text-[#C850C0] transition-colors flex items-center gap-2"
                    >
                      fatima.mazhar@email.com
                      {emailCopied ? (
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-white font-medium text-[14px]">Lahore, Pakistan</div>
                  </div>
                </div>
              ...
              <div className="flex gap-3">
                {[Github, Linkedin, Twitter, Mail].map((Icon, i) => (
                  <button
                    key={i}
                    className="w-12 h-12 rounded-full flex items-center justify-center text-white/70 hover:text-white transition-all glass-card"
                    onMouseEnter={(e) => {
                      e.currentTarget.style.background =
                        'linear-gradient(135deg, #C850C0, #4158D0)';
                      e.currentTarget.style.boxShadow = '0 0 20px rgba(200, 80, 192, 0.4)';
            ...
            <GlassCard className="p-8">
              <form onSubmit={handleFormSubmit}>
                ...
                <textarea
                  placeholder="Message"
                  rows={5}
                  className="form-input mb-6 w-full resize-none"
                  required
                />
                <button
                  type="submit"
      ...
      <footer className="bg-[#0D0B1E] border-t border-white/[0.08] py-10 px-8">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="text-center text-white/30 text-[12px]">
            © 2025 Fatima Mazhar. Built with ResuFlow.
          </div>
        </div>
      </footer>
      ...
      <style>{`
        * {
        ...
        .glass-card-hover:hover {
          ...
          box-shadow: 0 0 32px rgba(200, 80, 192, 0.15);
        ...
        .form-input:focus {
          ...
          box-shadow: 0 0 16px rgba(200, 80, 192, 0.15);
        }
      `}</style>
    </div>
  );
